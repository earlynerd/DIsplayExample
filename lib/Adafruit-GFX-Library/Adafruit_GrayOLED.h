...
#define GRAYOLED_SETMASTERCURRENT 0xC7   ///current scaling
#define GRAYOLED_SETPRECHARGEVOLTAGE 0xBB   ///
#define GRAYOLED_SETCONTRAST 0xC1   ///< contrast for almost all OLEDs
...
public:
  ...
  void setMasterCurrent(uint8_t level);
  void setPreChargeVoltage(uint8_t level);
